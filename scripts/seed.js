...
const rawProducts = [
  ...
  { title: 'AstralPool Pump Unit',       description: 'High-performance Spanish pump unit designed for continuous operation in commercial pools.',                         category: 'cat-pumps',     brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/معدات استرال/unnamed.jpg',                        featured: false },
  ...
  { title: 'AstralPool Side-Mount Filter',description:'Side-mount sand filter with large filtration surface for high-flow commercial installations.',                     category: 'cat-filters',   brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/معدات استرال/11.jpg',                             featured: false },
  { title: 'AstralPool Top-Mount Filter',description: 'Compact top-mount filter ideal for residential pools with limited equipment room.',                                 category: 'cat-filters',   brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/معدات استرال/16.jpg',                             featured: false },
  { title: 'AstralPool Complete System', description: 'Full AstralPool filtration and circulation system — pump, filter, and fittings bundle.',                           category: 'cat-filters',   brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/معدات استرال/unnamed (1).jpg',                    featured: false },
  { title: 'AstralPool Equipment Package',description:'Turnkey AstralPool equipment package for new pool installations and renovations.',                                  category: 'cat-filters',   brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/معدات استرال/unnamed.png',                        featured: false },
  ...
  { title: 'Underwater Spotlight — Halogen', description: 'Classic halogen underwater spotlight providing warm white illumination for pool interiors.',                   category: 'cat-lights',    brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/كشاف حله.jpg',                                             featured: false },
  { title: 'Surface-Mount Pool Spotlight',description: 'Surface-mount LED spotlight for pool walls and steps, easy retrofit installation.',                               category: 'cat-lights',    brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/كشاف لطش.jpg',                                             featured: false },
  { title: 'Surface-Mount Spotlight Pro',description: 'Heavy-duty surface-mount spotlight with stainless steel housing for long-term durability.',                        category: 'cat-lights',    brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/كشاف لطش2.jpg',                                            featured: false },
  ...
  { title: 'Pool Entry Ladder — 3 Step', description: 'Three-step stainless steel entry ladder with anti-slip treads for safe pool access.',                              category: 'cat-ladders',   brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/سلم.jpg',                                                  featured: false },
  ...
  { title: 'Pool Brush & Net Set',       description: 'Professional-grade wall brush and leaf net set for daily pool maintenance.',                                        category: 'cat-cleaners',  brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/فرشه.jpg',                                                 featured: false },
  ...
  // ── Fittings ───────────────────────────────────────────────────────────
  { title: 'Pool Inlet Fitting — Eyeball',description:'Adjustable eyeball return inlet fitting for directing water flow inside the pool.',                                 category: 'cat-fittings',  brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/اسبوت.jpg',                                                featured: false },
  { title: 'Flexible Pool Hose',         description: 'Heavy-duty flexible hose for connecting pool equipment — pressure and UV resistant.',                               category: 'cat-fittings',  brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/خرطوم.jpg',                                                featured: false },
  { title: 'Pool Grating Panel',         description: 'Anti-slip ABS grating panel for pool surrounds, overflow channels, and wet areas.',                                category: 'cat-fittings',  brand: 'brand-maxpool',  brandName: 'Max Pool',   image: 'assets/images/شبكه.jpg',                                                 featured: false },
  { title: 'Pool Accessory Set A',       description: 'Complete pool accessory bundle including skimmer basket, wall fittings, and drain cover.',                         category: 'cat-fittings',  brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/اكسسوارات/unnamed.jpg',                           featured: false },
  { title: 'Pool Accessory Set B',       description: 'Supplementary accessory kit with replacement parts for standard pool installations.',                               category: 'cat-fittings',  brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/اكسسوارات/unnamed (1).jpg',                       featured: false },
  { title: 'Pool Accessory Set C',       description: 'Overflow pool accessory set including gutter fittings and surface skimmer components.',                            category: 'cat-fittings',  brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/اكسسوارات/unnamed (2).jpg',                       featured: false },
  { title: 'Pool Accessory Set D',       description: 'Maintenance accessory kit with vacuum plate, hose connectors, and brush adapters.',                                category: 'cat-fittings',  brand: 'brand-astral',   brandName: 'AstralPool', image: 'assets/images/products/اكسسوارات/unnamed (3).jpg',                       featured: false },
];
